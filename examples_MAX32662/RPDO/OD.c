...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x6001_remoteCounter = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_var_t o_6001_remoteCounter;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_1600_RPDOMappingParameter = {
        ...
        {
            .dataOrig = &OD_RAM.x1600_RPDOMappingParameter.mappedObject1,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        }
    },
    .o_6001_remoteCounter = {
        .dataOrig = &OD_PERSIST_COMM.x6001_remoteCounter,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6001, 0x01, ODT_VAR, &ODObjs.o_6001_remoteCounter, NULL},
