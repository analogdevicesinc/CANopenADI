...
int main (void){
    ...
    uint8_t pendingNodeId = 30; /* read from dip switches or nonvolatile memory, configurable by LSS slave */
    uint8_t activeNodeId = 30; /* Copied from CO_pendingNodeId in the communication reset section */
